...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Peppeno',			'new-bolly',			'"i dont work for anything but im still here!"',		'https://youtube.com/@es_alguien123',		'AAAA00'],
			['Blop',				'blop',			'',	"00FF44"],
			['Krikoso Log Discord',				'discordkrikolandia',			'Use this to join the discord server',		'https://discord.gg/jsd5yxX66M',		"0000AA"],
			[''],
			['Psych Engine Team'],
